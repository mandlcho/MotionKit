"""
BS Anim Export — Standalone
Run in the SOURCE Maya instance from the Script Editor.
...
try:
    _bs_anim_export_win.close()
    _bs_anim_export_win.deleteLater()
except Exception:
    pass
_bs_anim_export_win = ExportUI()
_bs_anim_export_win.show()
