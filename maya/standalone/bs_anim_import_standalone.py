"""
BS Anim Import — Standalone
Run in the TARGET Maya instance from the Script Editor.
Imports blendshape weight curves from a JSON exported by bs_anim_export.
...
try:
    _bs_anim_import_win.close()
    _bs_anim_import_win.deleteLater()
except Exception:
    pass
_bs_anim_import_win = ImportUI()
_bs_anim_import_win.show()
